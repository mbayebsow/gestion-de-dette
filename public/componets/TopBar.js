document.getElementById("AppHeader").innerHTML = `
    <div class="w-auto  flex flex-row justify-between text-center text-lg text-black font-inter">
        <div class="rounded-lg bg-white shadow-lg w-auto h-10 flex flex-row items-center justify-between px-5">
            <b class="mr-5 text-xs" x-text="moment().format('dddd Do MMM YYYY')"></b>
        ...
        <div class="h-10 flex flex-row gap-3">
            <div x-data="{ isOpen: false }" class="relative inline-block ">
                <button @click="isOpen = !isOpen" class="h-10 relative shadow-lg flex items-center p-2 text-sm text-black bg-white border rounded-md focus:ring-opacity-40  focus:ring-black focus:ring focus:outline-none">
                    <span class="mr-3 text-black">Jane Doe</span>
                ...
                <div x-show="isOpen" @click.away="isOpen = false" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90" class="absolute right-0 z-20 w-56 py-2 mt-2 overflow-hidden origin-top-right bg-white rounded-md shadow-xl" >
                    ...
                    <a href="#" class="flex items-center p-3 text-sm text-black capitalize transition-colors duration-300 transform ">
            ...
            <button class="cursor-pointer [border:none] w-10 h-10 p-[0] bg-red-500 flex justify-center items-center rounded-lg shadow-lg">
